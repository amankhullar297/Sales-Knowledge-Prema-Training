...
public class FeedController {
	...
	public ModelAndView feedbackEnter(ModelMap model, HttpServletRequest request)
	{
		...
		System.out.println("The session is set to "+regOrg);
	...
	public ModelAndView feedbackDelete(@RequestParam("fbid") int fbid, HttpServletRequest request) {
	...
	public ModelAndView feedbackUpdateLoad(@RequestParam("fbid") int fbid, HttpServletRequest request) {
	...
	public ModelAndView studentInsert(@ModelAttribute("feedback") Feedback feedback, HttpServletRequest request) {
