...
public class PlanHistoryController {
	...
	public ModelAndView planHistoryLoad(ModelMap model ) {
		...
		modelAndView.setViewName("orgAdminPlanHistory");
	...
	@RequestMapping(value="/planHistoryInsert", method=RequestMethod.POST)
	public ModelAndView planHistoryInsert(@ModelAttribute("planHistory")  PlanHistory p) {
