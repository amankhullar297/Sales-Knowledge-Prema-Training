				...
				<div class="card">
					...
					<div class="body">
						<form:form id="form_advanced_validation" method="POST" action="ClientCompanyInsert" modelAttribute="cc" >
							 <div class="row clearfix">
                                ...
                                <p>
                                        ...
                                        <div class="form-line">
                                           ...
                                           <form:input type="text" id="cn" class="form-control" placeholder="Enter Client Name" path="clientName" required="true"/>
                                ...
                                <p>
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <form:input type="text" id="ca" class="form-control" placeholder="Enter the Client Address" path="clientAddress" required="true"/>
                            ...
                            <input type="submit" value="Insert" onclick="alertName()" class="btn btn-success"/>
