		...
		<div class="row clearfix">
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<div class="card">
					...
					<div class="body">
						<form:form action="salesKnowledgeLoad" modelAttribute="salesKnowledge" id="form_advanced_validation" method="POST">
									...
									<tbody>
										...
										<c:forEach var="salesKnowledge" items="${salesKnowledgeList}">
											<tr>
												...
												<td>
												<form action="KnowledgeRate" method="post">
												<input type="hidden" name="salesId" value="${salesKnowledge.salesId }">
